...
{
  QObject::connect( load_CoM_btn, &QPushButton::clicked, this, &MainWindow::loadTriggered );
...
void MainWindow::createWidgets()
{
  ...
  run_ctrl_btn->setText("RUN GRAV COMP");
  ...
  load_CoM_btn = new QPushButton;
  load_CoM_btn->setText("load CoM data...");
  load_CoM_btn->setFont(font1);

  save_btn = new QPushButton;
  save_btn->setText("save CoM data...");
  save_btn->setFont(font1);

  save_as_btn = new QPushButton;
  save_as_btn->setText("save CoM data as...");
...
void MainWindow::createLayouts()
{
  ...
  load_save_layout->addWidget(load_CoM_btn);
...
{
  load_data_path = QFileDialog::getOpenFileName(this, tr("Load CoM Data"), default_data_path.c_str(), "Binary files (*.bin)").toStdString();
